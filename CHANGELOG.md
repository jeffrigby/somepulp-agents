...
### Fixed
- **Marketplace**: Added `code-quality-auditor` → `codebase-health` to the `renames` map — an early plugin name missed in the v3.2.0 lineage, so installs under that name migrate cleanly too.
