---
name: code-auditing
description: This skill provides code auditing methodology, checklists, and best practices. Use when performing comprehensive code quality audits, security reviews, or identifying technical debt.
---
